...
PACKAGECONFIG[bzip2] = "-DENABLE_BZIP2_COMPRESSION=ON,,bzip2"
PACKAGECONFIG[lzma] = "-DENABLE_LZMA_COMPRESSION=ON,,xz"
PACKAGECONFIG[zstd] = "-DENABLE_ZSTD_COMPRESSION=ON,,zstd"
